...
const Select = ({ options = [], label = "Please select an option ...", onOptionSelected: handler, renderOption }) => {
    ...
    return (React.createElement("div", { className: "dse-select" },
        ...
        isOpen && (React.createElement("ul", { role: "menu", "aria-hidden": isOpen ? undefined : false, id: "dse-select-list", style: { top: overlayTop }, className: `dse-select__overlay ${isOpen ? "dse-select__overlay--open" : ""}` }, options.map((option, optionIndex) => {
